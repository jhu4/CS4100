...
bool SoccerPitch::Render()
{
  ...
  gdi->TextAtPos((m_cxClient/2)-300, m_cyClient-18, m_pRedTeam->Name() + ": " + ttos(m_pBlueGoal->NumGoalsScored()));

  gdi->TextColor(Cgdi::blue);
  gdi->TextAtPos((m_cxClient/2)+10, m_cyClient-18, m_pBlueTeam->Name() + ": " + ttos(m_pRedGoal->NumGoalsScored()));
