...
BurkeGlobalPlayerState* BurkeGlobalPlayerState::Instance()
{
...
void BurkeGlobalPlayerState::Execute(FieldPlayer* player)                                     
{
...
bool BurkeGlobalPlayerState::OnMessage(FieldPlayer* player, const Telegram& telegram)
{
  switch(telegram.Msg)
  {
  case Msg_ReceiveBall:
    {
      ...
      //change state 
      player->GetFSM()->ChangeState(BurkeReceiveBall::Instance());
  ...
  case Msg_SupportAttacker:
    {
      ...
      if (player->GetFSM()->isInState(*BurkeSupportAttacker::Instance()))
      {
        return true;
      }
      ...
      //change the state
      player->GetFSM()->ChangeState(BurkeSupportAttacker::Instance());
 ...
 case Msg_Wait:
    {
      //change the state
      player->GetFSM()->ChangeState(BurkeWait::Instance());
  ...
  case Msg_GoHome:
    {
      ...
      player->GetFSM()->ChangeState(BurkeReturnToHomeRegion::Instance());
...
BurkeChaseBall* BurkeChaseBall::Instance()
{
...
void BurkeChaseBall::Enter(FieldPlayer* player)
{
...
void BurkeChaseBall::Execute(FieldPlayer* player)                                     
{
  //if the ball is within kicking range the player changes state to BurkeKickBall.
  if (player->BallWithinKickingRange())
  {
    player->GetFSM()->ChangeState(BurkeKickBall::Instance());
...
void BurkeChaseBall::Exit(FieldPlayer* player)
{
...
BurkeSupportAttacker* BurkeSupportAttacker::Instance()
{
...
void BurkeSupportAttacker::Enter(FieldPlayer* player)
{
...
void BurkeSupportAttacker::Execute(FieldPlayer* player)                                     
{
  //if his team loses control go back home
  if (!player->Team()->InControl())
  {
    player->GetFSM()->ChangeState(BurkeReturnToHomeRegion::Instance()); return;
  } 
...
void BurkeSupportAttacker::Exit(FieldPlayer* player)
{
...
BurkeReturnToHomeRegion* BurkeReturnToHomeRegion::Instance()
{
...
void BurkeReturnToHomeRegion::Enter(FieldPlayer* player)
{
  player->Steering()->ArriveOn();
...
void BurkeReturnToHomeRegion::Execute(FieldPlayer* player)
{
  if (player->Pitch()->GameOn())
  {
    ...
    {
      player->GetFSM()->ChangeState(BurkeChaseBall::Instance());
...
void BurkeReturnToHomeRegion::Exit(FieldPlayer* player)
{
  player->Steering()->ArriveOff();
}
...
void BurkeWait::Enter(FieldPlayer* player)
{
  #ifdef PLAYER_STATE_INFO_ON
...
void BurkeWait::Execute(FieldPlayer* player)
{    
...
void BurkeWait::Exit(FieldPlayer* player){}
...
BurkeKickBall* BurkeKickBall::Instance()
{
...
void BurkeKickBall::Enter(FieldPlayer* player)
{
...
void BurkeKickBall::Execute(FieldPlayer* player)
{ 
  ...
  {   
    ...
    player->GetFSM()->ChangeState(BurkeDribble::Instance());
  }   
}
...
BurkeDribble* BurkeDribble::Instance()
{
...
void BurkeDribble::Enter(FieldPlayer* player)
{
  //let the team know this player is controlling
  player->Team()->SetControllingPlayer(player);
...
void BurkeDribble::Execute(FieldPlayer* player)
{
  ...
  BurkeSoccerTeam* team = (BurkeSoccerTeam*) player->Team();
...
BurkeReceiveBall* BurkeReceiveBall::Instance()
{
...
void BurkeReceiveBall::Enter(FieldPlayer* player)
{
...
void BurkeReceiveBall::Execute(FieldPlayer* player)
{
...
void BurkeReceiveBall::Exit(FieldPlayer* player)
{
  player->Steering()->ArriveOff();
  player->Steering()->PursuitOff();
