...
void QuenchThirst::Enter(Miner* pMiner)
{
  ...
  {    
    ...
    //let Sal know I'm in the saloon
    Dispatch->DispatchMessage(SEND_MSG_IMMEDIATELY,          //time delay
                              pMiner->ID(),                  //ID of sender
                              ent_Sal,                       //ID of recipient
                              Msg_BobsEnteringSaloon,        //the message
                              NO_ADDITIONAL_INFO);
  }
}
...
{ 
	//Miner is going to leave saloon only if he's not insulted
	if(!pMiner->InsultedByBarFly()){
	  ...
	  Dispatch->DispatchMessage(SEND_MSG_IMMEDIATELY,    //time delay
	                          pMiner->ID(),            //ID of sender
	                          ent_Sal,                 //ID of recipient
	                          Msg_BobsLeavingSaloon,   //the message
	                          NO_ADDITIONAL_INFO); 
  }
  else{
    //Miner is going to give a bar fly some lessions
    pMiner->ReadyToPunchBarFly();
...
void MinerFightin::Enter(Miner* pMiner){
	cout<<"\n"<<GetNameOfEntity(pMiner->ID())<<":"<<"You provoked me sucessfully!";
}
